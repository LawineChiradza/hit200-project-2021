...
class Browser
{
    ...
    public function __construct()
    {
        ...
        static::useChromedriver(env('CHROMEDRIVER_PATH', base_path('vendor/laravel/dusk/bin/chromedriver-linux')));
     ...
     */
     protected function driver()
     {
         $options = (new ChromeOptions)->addArguments([
             ...
             '--log-level=3',
             '--silent'
         ])->setBinary(env('CHROME_PATH', '/usr/bin/google-chrome-stable'));
